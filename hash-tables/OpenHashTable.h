#ifndef __OPEN_HASH_TABLE_H
#define __OPEN_HASH_TABLE_H
...
template<typename Key, typename Value, typename HashFn = std::hash<Key>, typename EqualFn = std::equal_to<Key>>
class OpenHashTable {
public:
  OpenHashTable(unsigned int initialCapacity = 0)
